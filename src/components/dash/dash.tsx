...
import { MobileMenuButton } from "@components/dash/mobilemenubutton";
import { NavBreadcrumb } from "@components/dash/navbread";
import { NavSectionTitle } from "@components/dash/navsectiontitle";
import { ScrollArea } from "@components/dash/scrollarea";
import { SearchInput } from "@components/dash/searchinput";
import { SidebarLink } from "@components/dash/sidebarlink";
import { useMobileMenuState } from "@components/dash/usemobilemenustate";
				...
				<Box fontSize="sm" lineHeight="tall">
					...
					<ScrollArea pt="5" pb="6">
						...
						<Stack pb="6">
							...
							<SidebarLink icon={<BsPencilSquare />}>
								Drafts
							</SidebarLink>
						</Stack>
						<Stack pb="6">
